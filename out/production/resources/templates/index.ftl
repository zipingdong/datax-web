...
<div class="container theme-showcase" role="main">
  <form class="form-signin" id="formid">
    ...
    <div class="row padding0">
      <div class="col-md-6">
        <div class="table">
          <div class="form-group"><label>通道数</label><input class="form-control" type="input" id="speed.channel" name="speed.channel"></div>
          <div class="form-group"><label>传输速度</label><input class="form-control" type="input" id="speed.byte" name="speed.byte"></div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="table">
          <div class="form-group"><label>错误记录数</label><input class="form-control" type="input" id="errorLimit.record" name="errorLimit.record"></div>
          <div class="form-group"><label>错误百分比</label><input class="form-control" type="input" id="errorLimit.percentage" name="errorLimit.percentage"></div>
        </div>
      </div>
    </div>
